...
const Navbar = () => {
    ...
    return (
        <div className="sticky top-0 z-10 bg-opacity-30 backdrop-blur-md py-2 sm:py-3 shadow-md">
            <div className="w-11/12 md:w-10/12 mx-auto flex justify-between items-center">
                ...
                <div className="flex justify-end items-center gap-1 sm:gap-2 lg:gap-3 xl:gap-4">
